...
export default function Welcome() {
    ...
    return (
        <AppProvider>
            <Page>
                <TitleBar title="Laravel Shopify app template">
                    <button variant="primary" onClick={() => console.log('clicked generate product')}>
                        Generate a product
                    </button>
                </TitleBar>
                        ...
                        <Layout.Section>
                            <Card>
                                <BlockStack gap="500">
                                    ...
                                    <InlineStack gap="300">
                                        <Button loading={false} onClick={() => setProductId('1234567890')}>
                                            Generate a product
                                        </Button>
